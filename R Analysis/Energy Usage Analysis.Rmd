...
The data analysed comprises four parts, all daily data:
...
-   House Occupation: A Y/N flag to indicate if the house is occupied or not
...
-   Temp_Avg - the mean daily temperature in $^\circ$C and is derived from 6 readings taken at 4 hourly intervals over a 24 hour period.
